...
#takes the Program file name, copies this entire program into a txt file 
# and writes it to a txt file with the same name
#
# AS the programs name with .txt extension
#
# I use this to write overwrite the rest of the txt files with new 
# new text file containing this Entire code.
